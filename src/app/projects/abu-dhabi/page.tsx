...
export default function AbuDhabiProjectsPage() {
  const abuDhabiProjects = projectsData.filter(project => 
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] pt-32 pb-20 font-sans">
      <div className="max-w-[1400px] mx-auto px-4 md:px-6">
        ...
        {/* Page Title */}
        <h1 className="text-2xl md:text-3xl font-bold text-[#1e2350] mb-8">
          Real Estate Projects in Abu Dhabi
        </h1>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mb-8 gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-1">
              ...
              <button suppressHydrationWarning className="w-8 h-8 flex items-center justify-center rounded hover:bg-white border border-transparent hover:border-gray-200 text-gray-600 text-xs font-medium">2</button>
              <button suppressHydrationWarning className="w-8 h-8 flex items-center justify-center rounded hover:bg-white border border-transparent hover:border-gray-200 text-gray-600 text-xs font-medium">3</button>
              <span className="px-1 text-gray-400">...</span>
              <button suppressHydrationWarning className="w-8 h-8 flex items-center justify-center rounded hover:bg-white border border-transparent hover:border-gray-200 text-gray-600 text-xs font-medium">13</button>
              <button suppressHydrationWarning className="w-8 h-8 flex items-center justify-center rounded hover:bg-white border border-transparent hover:border-gray-200 text-gray-600 text-xs font-medium">14</button>
            </div>
            <button suppressHydrationWarning className="w-8 h-8 flex items-center justify-center rounded border border-gray-200 text-gray-400 hover:bg-white transition-colors">
            ...
            >
              ...
              <div className="relative h-64 overflow-hidden">
                <Image 
                  ...
                  priority={abuDhabiProjects.indexOf(project) < 4}
              ...
              <div className="p-5 flex flex-col flex-1">
                ...
                <div className="mt-auto pt-4 border-t border-gray-50 flex items-center justify-between text-[11px] text-gray-500 font-bold uppercase tracking-tighter">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="whitespace-nowrap">{project.features.handover.split(' ')[0]} {project.features.handover.split(' ')[1]}</span>
                  </div>
                </div>
              </div>
            </Link>
        ...
        <div className="flex items-center justify-center mt-16 gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <button suppressHydrationWarning className="w-10 h-10 flex items-center justify-center rounded bg-white border border-gray-200 hover:border-gray-300 text-gray-600 text-sm font-medium transition-colors shadow-sm">3</button>
              <span className="px-2 text-gray-400">...</span>
              <button suppressHydrationWarning className="w-10 h-10 flex items-center justify-center rounded bg-white border border-gray-200 hover:border-gray-300 text-gray-600 text-sm font-medium transition-colors shadow-sm">13</button>
              <button suppressHydrationWarning className="w-10 h-10 flex items-center justify-center rounded bg-white border border-gray-200 hover:border-gray-300 text-gray-600 text-sm font-medium transition-colors shadow-sm">14</button>
            </div>
            <button suppressHydrationWarning className="w-10 h-10 flex items-center justify-center rounded border border-gray-200 text-gray-400 hover:bg-white transition-colors shadow-sm">
