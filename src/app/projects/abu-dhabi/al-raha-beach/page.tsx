...
export default function AlRahaBeachPage() {
  const [viewMode, setViewMode] = useState<'gallery' | 'map' | 'list'>('gallery');
  const [currentPage, setCurrentPage] = useState(1);
  const itemsPerPage = 12;

  // Filter projects for Al Raha Beach
    ...
    <main className="min-h-screen bg-[#f8f9fb] pt-32 pb-20">
      ...
      <div className="bg-white border-b border-gray-100">
        <div className="container mx-auto px-4 py-4">
          <nav className="flex text-xs text-gray-400 gap-2 items-center">
            ...
            <span>/</span>
            <span className="text-gray-600">Al Raha Beach</span>
          </nav>
        </div>
      </div>
      ...
      <div className="bg-white border-b border-gray-100 mb-8">
        <div className="container mx-auto px-4 py-12">
          ...
          >
            Real Estate Projects in Al Raha Beach, Abu Dhabi
          </h1>
      ...
      <div className="container mx-auto px-4">
        ...
        {filteredProjects.length === 0 && (
          <div className="py-20 text-center">
            ...
            <p className="text-gray-500">We couldn't find any projects in Al Raha Beach at the moment.</p>
          </div>
        )}
