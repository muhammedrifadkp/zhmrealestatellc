...
export default function SharjahProjectsPage() {
  const sharjahProjects = projectsData.filter(project => 
    project.location.toLowerCase().includes("sharjah")
  );
      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-6">
        ...
        <div className="mb-10 text-center md:text-left">
          <h1 className="text-3xl md:text-4xl font-bold text-[#1e2350] mb-2">
            Real Estate Projects in Sharjah
          </h1>
          <p className="text-gray-500 text-sm md:text-base font-medium">
            Discover the future of Sharjah's urban landscape through these landmark residential and commercial developments.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mb-8 gap-4">
          ...
          <div className="flex items-center gap-2">
            <span className="text-xs text-gray-400 mr-2 font-medium">Showing all {sharjahProjects.length} results</span>
            ...
            >
              ...
              <div className="relative h-64 overflow-hidden">
                <Image 
                  ...
                  priority={sharjahProjects.indexOf(project) < 4}
