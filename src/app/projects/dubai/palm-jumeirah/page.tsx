...
export default function PalmJumeirahPage() {
  ...
  // Filter projects for Palm Jumeirah
  const filteredProjects = useMemo(() => {
    return projectsData.filter(project => 
      project.location.toLowerCase().includes("palm jumeirah")
    );
  }, []);
    ...
    <main className="min-h-screen bg-[#f8f9fb] pt-32 pb-20">
      ...
      <div className="bg-white border-b border-gray-100">
        <div className="container mx-auto px-4 py-4">
          <nav className="flex text-xs text-gray-400 gap-2 items-center">
            ...
            <span>/</span>
            <span className="text-gray-600">Palm Jumeirah</span>
          </nav>
        </div>
      </div>
      ...
      <div className="bg-white border-b border-gray-100 mb-8">
        <div className="container mx-auto px-4 py-12">
          ...
          >
            Real Estate Projects in Palm Jumeirah, Dubai
          </h1>
      ...
      <div className="container mx-auto px-4">
        ...
        {filteredProjects.length === 0 && (
          <div className="py-20 text-center">
            ...
            <p className="text-gray-500">We couldn't find any projects in Palm Jumeirah at the moment.</p>
          </div>
        )}
