...
export default function ProjectsLocationPage() {
  ...
  const getProjectUrl = (slug: string) => {
    return `/projects/${locationParam}/${slug}`;
  };
    ...
    <main className="min-h-screen bg-[#f8f9fb] pt-32 pb-20 font-sans">
      ...
      <div className="bg-white border-b border-gray-100 mb-8">
        <div className="container mx-auto px-4 py-12">
          ...
          >
            <span className="text-primary font-bold text-xs uppercase tracking-[0.3em] mb-4">Complete Collection</span>
            <h1 
              className="text-4xl md:text-6xl font-bold text-secondary text-center"
              style={{ fontFamily: '"Cormorant Garamond", serif' }}
            >
              Projects in {locationTitle}
            </h1>
      ...
      <div className="container mx-auto px-4">
        ...
        {filteredProjects.length === 0 && (
          <div className="py-20 text-center">
            ...
            <p className="text-gray-500">We couldn&apos;t find any projects in {locationTitle} at the moment.</p>
          </div>
        )}
