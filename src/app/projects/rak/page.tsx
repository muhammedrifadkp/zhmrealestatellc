...
export default function RAKProjectsPage() {
  const rakProjects = projectsData.filter(project => 
    project.location.toLowerCase().includes("ras al khaimah")
  );
      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-6">
        ...
        <div className="mb-10 text-center md:text-left">
          ...
          <p className="text-gray-500 text-sm md:text-base font-medium">
            Discover luxury beachfront living and island residences in the rising emirate of Ras Al Khaimah.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mb-8 gap-4">
          ...
          <div className="flex items-center gap-2">
            <span className="text-xs text-gray-400 mr-2 font-medium">Showing all {rakProjects.length} results</span>
            ...
            >
              ...
              <div className="relative h-64 overflow-hidden">
                <Image 
                  ...
                  priority={rakProjects.indexOf(project) < 4}
                ...
                <div className="absolute top-4 left-4 bg-[#1e2350] text-white text-[10px] font-bold px-3 py-1.5 rounded uppercase tracking-widest shadow-lg z-10">
                  {project.features.handover.toLowerCase().includes("completed") ? "COMPLETED" : "OFF-PLAN"}
                </div>
              </div>
